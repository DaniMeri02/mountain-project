...
async function fetchPOIs() {
  console.log('ÌøîÔ∏è Downloading data from OpenStreetMap (Overpass API)...');
  ...
  try {
    ...
    console.log(`‚úÖ Found ${data.elements.length} raw elements.`);
    ...
    console.log(`Ì∑∫Ô∏è Saved ${features.length} Points of Interest to ${outputPath}`);
